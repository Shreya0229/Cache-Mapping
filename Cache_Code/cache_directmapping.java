import java.io.BufferedReader;
	...
	public class cache_directmapping {
		...
		public static void main(String[] args) throws IOException {
			...
			System.out.println("THE DIRECT MAPPING CACHE");
			System.out.println();
			...
			if(input.equals("read")) {
				...
				int tag_foundat=-1;
					...
					if(tag_num==tag_array[index_decimal]) {
						tag_foundat=index_decimal;
				...
				for(int i=0; i<cache_line; i++) {
					...
					String ind_inbinary= Long.toBinaryString(i);
			...
			if(input.equals("write")) {
				...
				if(tag_foundat==-1) {
						...
						if(tag_array[index_decimal]==-5) {
							tag_array[index_decimal]=tag_num;
							data_array[index_decimal][offset_decimal]= value;
						...
						long replaced_tag= tag_array[index_decimal];
						
						
						for(int i=0; i<block_size; i++) {
							data_array[index_decimal][i]=-5;
						}
						tag_array[index_decimal]=tag_num;
						data_array[index_decimal][offset_decimal]= value;
